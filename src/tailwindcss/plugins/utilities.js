...
module.exports = plugin(({ addComponents }) => {
  ...
  addComponents({
    ...
    ".bg-card": {
      ...
      backgroundColor:
        "rgba(var(--bg-card-rgb), var(--tw-bg-opacity)) !important",
    },
    ".bg-default": {
      "--tw-bg-opacity": "1 !important",
      backgroundColor:
    ...
    ".bg-dialog": {
      "--tw-bg-opacity": "1 !important",
      backgroundColor:
        "rgba(var(--bg-dialog-rgb), var(--tw-bg-opacity)) !important",
    },
    ".ring-bg-default": {
      "--tw-ring-opacity": "1 !important",
      "--tw-ring-color":
        "rgba(var(--bg-default-rgb), var(--tw-ring-opacity)) !important",
    },
    ".ring-bg-card": {
      "--tw-ring-opacity": "1 !important",
      "--tw-ring-color":
        "rgba(var(--bg-card-rgb), var(--tw-ring-opacity)) !important",
    },
    ".icon": {
      "--tw-text-opacity": "1",
